...
public class Sprzataczki extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Sprzataczki(Connection conn) {

		setResizable(false);
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 450, 300);
		setTitle("Sprz¹taczki");
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"IDSprz\u0105taczki", "Imi\u0119", "Nazwisko", "PESEL", "Data Zatrudnienia", "Pensja", "IDKierownika"
			}
		) {
